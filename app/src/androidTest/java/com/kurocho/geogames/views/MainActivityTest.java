...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ...
        ViewInteraction actionMenuItemView = onView(
                allOf(withId(R.id.action_search), withContentDescription("Search games"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.download), withText("download"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction frameLayout = onView(
                allOf(withId(R.id.main_activity_progress_overlay),
                        childAtPosition(
